...
def get_prepositional_phrase(quantity):
    ...
    frase = f'{preposition} {determiner} {noun}'
    return frase



def get_adjective():
    adjectives = ['big', 'happy', 'old', 'angry', 'good', 'hard', 'hot', 'small']
...
def get_adverb():
    adverbs = ['early', 'carefully', 'slowly', 'terribly']
...
def make_sentence(quantity, tense):
    ...
    frase2 = get_prepositional_phrase(quantity)
    adjective = get_adjective()
    adverb = get_adverb()
    sentence = f'{determiner} {adjective} {noun} {frase} {adverb} {verb} {frase2} '
