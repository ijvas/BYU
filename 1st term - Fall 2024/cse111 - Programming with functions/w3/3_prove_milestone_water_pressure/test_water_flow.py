...
from water_flow import water_colum_height, pressure_gain_from_water_height, pressure_loss_from_pipe


def test_water_column_height():
    assert water_colum_height(0.0, 0.0) == approx(0.0, abs=0.1)
    assert water_colum_height(0.0, 10.0) == approx(7.5, abs=0.1)
    assert water_colum_height(25.0, 0.0) == approx(25.0, abs=0.1)
    assert water_colum_height(48.3, 12.8) == approx(57.9, abs=0.1)
